...
public static class BuildInfo
{
    ...
    public const string Name                            = "EternalBlizzard";
    ...
    public const string GUIName                         = "Eternal Blizzard";
    ...
    public const string Description                     = "A modification which sets the weather to a blizzard forever.";
    ...
    public const string Product                         = "EternalBlizzard";
